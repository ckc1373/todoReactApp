...
var TodoApp = function (_React$Component) {
  ...
  _createClass(TodoApp, [{
    ...
    value: function addTodo(task) {
      var thisState = this;
      _axios2.default.post(dbUrl + '/add', { task: task, completed: false }).then(function (response) {
        thisState.setState({ todos: [].concat(_toConsumableArray(thisState.state.todos), [{ task: task, completed: false }]) });
    ...
    value: function removeTodo(id) {
      ...
      _axios2.default.post(dbUrl + '/remove', { id: id }).then(function (response) {
        var oldTodo = thisState.state.todos;
        var index = oldTodo.findIndex(function (item) {
          return item._id === id;
        });
...
function TodoList(props) {
          return _react2.default.createElement(
                    ...
                    props.todos.map(function (data, i) {
                              return _react2.default.createElement(_Todo2.default, { key: data._id, id: data._id, task: data,
                                        todoXClick: function todoXClick(e) {
                                                  props.XClick(e);
                                        },
                                        itemToggle: function itemToggle(e) {
                                                  props.toggleThis(e);
                                        } });
                    })
          );
